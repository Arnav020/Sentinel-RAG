...
# Some Portkey workspaces block sending strategy/cache/retry config inline via
# the x-portkey-config header ("block_inline_config") and require referencing a
# saved Config by its pc-... slug instead. Use the slug when one is configured.
_PORTKEY_CONFIG = settings.PORTKEY_CONFIG_SLUG or GATEWAY_CONFIG

portkey_client = Portkey(
    api_key=settings.PORTKEY_API_KEY,
    config=_PORTKEY_CONFIG
)
